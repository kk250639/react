...
function App54(props) {
  ...
  function handleButton15Click() {
    axios.post("/api/main29/sub15", {});
  }

  return (
    <div>
      <button onClick={handleButton15Click}>post 15</button>
      <hr />
      <button onClick={handleButton14Click}>post 14</button>
      <hr />
      <button onClick={handleButton13Click}>post 13</button>
      <hr />
      <button onClick={handleButton12Click}>post 12 w/ of objects</button>
      <hr />
      <button onClick={handleButton11Click}>post 11 array)</button>
      <hr />
      <button onClick={handleButton10Click}>post 10 w/ data (array)</button>
      <hr />
